...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 shrink-0 bg-dark min-h-screen flex-col">
        {/* Logo */}
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-white/60 hover:text-white hover:bg-white/8 transition-colors mb-2"
          >
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-dark border-t border-white/10 flex items-center justify-around px-2 py-2 safe-area-bottom">
        {MOBILE_TAB_ITEMS.map(({ to, icon: Icon, label, badge }) => {
          const active =
