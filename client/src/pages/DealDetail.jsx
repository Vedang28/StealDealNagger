  ...
  return (
    <PageWrapper>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Link
          to="/deals"
          className="inline-flex items-center gap-1.5 text-sm text-muted dark:text-gray-400 hover:text-dark transition mb-6"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-1 text-sm text-muted dark:text-gray-400">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              onClick={openEdit}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-border dark:border-gray-700 text-sm font-medium text-dark dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 active:scale-95 transition"
            >
            ...
            {d.snoozedUntil ? (
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-warning text-sm font-medium text-warning hover:bg-yellow-50 dark:hover:bg-yellow-900/20 active:scale-95 transition"
              >
            ...
            <button
              ...
              disabled={deleting}
              className="flex items-center gap-1.5 px-4 py-2 rounded-lg border border-danger text-sm font-medium text-danger hover:bg-red-50 dark:hover:bg-red-900/20 active:scale-95 transition disabled:opacity-50"
            >
        ...
        {/* Snooze Banner */}
        {d.snoozedUntil && (
          <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg px-4 py-3 mb-6 flex items-center gap-2 text-sm text-yellow-800 dark:text-yellow-300">
            ...
            <dl className="space-y-3">
              {[
                ...
                <div key={label} className="flex justify-between gap-4">
                  <dt className="text-sm text-muted dark:text-gray-400 shrink-0">
                    {label}
                  </dt>
                  <dd className="text-sm font-medium text-dark dark:text-white text-right min-w-0 break-all">
                    {value}
                  </dd>
                </div>
              ))}
        ...
        {showSnooze && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 w-full max-w-md shadow-xl relative">
              <button
                onClick={() => setShowSnooze(false)}
                className="absolute top-4 right-4 text-muted dark:text-gray-400 hover:text-dark"
              >
                <X className="w-5 h-5" />
              </button>
              ...
              <form onSubmit={handleSnooze} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded-lg border border-border dark:border-gray-600 text-sm dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-primary/30 focus:border-primary transition"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-dark dark:text-white mb-1">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowSnooze(false)}
                    className="flex-1 px-4 py-2 rounded-lg border border-border dark:border-gray-700 text-sm font-medium text-dark dark:text-white hover:bg-gray-50 dark:hover:bg-gray-700 transition"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    disabled={snoozing}
                    className="flex-1 px-4 py-2 rounded-lg bg-primary hover:bg-primary-hover text-white text-sm font-semibold active:scale-95 transition disabled:opacity-50"
                  >
